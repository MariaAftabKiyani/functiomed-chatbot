...
#         if filename_lower.endswith('_de.pdf') or 'deutsch' in filename_lower:
#             return "DE"
#         elif filename_lower.endswith('_en.pdf') or 'englisch' in filename_lower or 'english' in filename_lower:
#             return "EN"
#         return None
...
#         """Ingest all PDF documents from base path"""
